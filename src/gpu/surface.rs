...
use crate::{
    ...
    ipc::cmif::sf,
    mem, results,
    service::cmif::{dispdrv, nv, vi},
    svc,
};
use core::{mem as cmem, ptr};
...
impl<NS: nv::INvDrvService> Surface<NS> {
    ...
    fn initialize(&mut self) -> Result<()> {
        ...
        self.buffer_alloc_layout = unsafe {
            alloc::alloc::Layout::from_size_align_unchecked(buf_size, mem::PAGE_ALIGNMENT)
        };
    ...
    fn finalize(&mut self) -> Result<()> {
        ...
        unsafe {
            alloc::alloc::dealloc(self.buffer_data, self.buffer_alloc_layout);
        }
